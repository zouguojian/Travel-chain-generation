...
from model import MultiLayerAttention
...
parser.add_argument('--model_file', default='./baselines/travelTrajectory/Transformer/best_model.pth', help='save the model to disk')
...
def test_model(model, test_loader, device):
    ...
    with torch.no_grad():
        ...
        np.savez_compressed('data/results/Transformer-tra', **{'prediction': cla_preds, 'truth': cla_labels})
...
def main():
    ...
    # 初始化模型
    model = MultiLayerAttention(field_dims=field_dims,
